<?php
  ...
  if($result1 != ""){
    while($row = $result1->fetch_assoc()){
      ...
      echo '<a href="?activate=' .  $row['id']  . '" class="btn" data-toggle="tooltip" data-placement="top" title="Recover" style="background: #07666d; margin-top: .4rem;" id="btnDelete"><image src="../images/recover.png" height="20" width="20"></image></a>';
      echo '</form>';
      echo '</td>';
    } 
  }
