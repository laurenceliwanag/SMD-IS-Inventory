<?php
  ...
  if($result1 != ""){
    while($row = $result1->fetch_assoc()){
     ...
     echo '<a href="?delete=' . $row['id'] . '" class="btn btn-danger" id="btnDelete" data-toggle="tooltip" data-placement="top" title="Deactivate" style="margin-top: .4rem;"><image src="../images/delete.png" height="20" width="20"></image></a>';
     echo '</div>';
     echo '</form>';
     echo '</td>';
     echo '</tr>';   
